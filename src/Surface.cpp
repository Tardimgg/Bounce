...
b2Fixture* Surface::buildOnEngine(b2World& world, float x, float y) {
...
std::pair<b2Fixture *, b2Fixture *> Surface::buildOnEngineWithTop(b2World &world, float x, float y) {
    b2Fixture* mainFixture = buildOnEngine(world, x, y);
